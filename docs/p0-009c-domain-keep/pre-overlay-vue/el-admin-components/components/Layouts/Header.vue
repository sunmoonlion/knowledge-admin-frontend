<template>
  <div :class="['flex items-center flex-nowrap h-[50px] z-100 bg-white dark:bg-dark']">
    ...
    <el-row class="items-center flex-nowrap">
      <ThemeSettings v-bind="defaultedSettings" @change="handleChange"></ThemeSettings>
      <DarkModeToggle
...
const defaultedSettings = computed(() => {
  const base: ThemeSettingsProps = {
    theme: '#409eff',
  ...
  return Object.assign({}, base, localProps.settings || {})
})
